...
exports.webmailAuth = async (req, res) => {
    ...
    const session = {
        ...
        imapHost: host || 'localhost',
        imapPort: port || 993,
        imapSecure: secure !== 'false'
    };
    ...
    req.session.smtpHost = session.imapHost || 'localhost';
    req.session.smtpPort = 587;
...
exports.webmailAutoLogin = async (req, res) => {
    ...
    const session = {
        userEmail: email,
        userPassword: password,
        imapHost: req.query.host || 'localhost',
...
exports.send = async (req, res) => {
    try {
        ...
        const smtpSession = {
            ...
            smtpHost: req.session.smtpHost || 'localhost',
